...
echo "================================="
echo "Experimento Cache 10MB"
echo "================================="

REDIS_MEMORY=10mb docker compose up -d --force-recreate redis
...
REDIS_MEMORY=10mb docker compose run --rm \
...
> data/resumen_cache_10mb.json

docker compose exec redis redis-cli INFO stats \
| grep evicted \
> data/evicted_cache_10mb.txt

docker compose exec redis redis-cli DBSIZE \
> data/dbsize_cache_10mb.txt

docker compose exec redis redis-cli CONFIG GET maxmemory \
> data/memory_cache_10mb.txt
...
echo "Experimento Cache 10MB terminado"