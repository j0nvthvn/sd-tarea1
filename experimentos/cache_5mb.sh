...
echo "================================="
echo "Experimento Cache 5MB"
echo "================================="

REDIS_MEMORY=5mb docker compose up -d --force-recreate redis
...
REDIS_MEMORY=5mb docker compose run --rm \
...
> data/resumen_cache_5mb.json

docker compose exec redis redis-cli INFO stats \
| grep evicted \
> data/evicted_cache_5mb.txt

docker compose exec redis redis-cli DBSIZE \
> data/dbsize_cache_5mb.txt

docker compose exec redis redis-cli CONFIG GET maxmemory \
> data/memory_cache_5mb.txt
...
echo "Experimento Cache 5MB terminado"