...
echo "================================="
echo "Experimento TTL 900 segundos"
echo "================================="

docker compose down

REDIS_MEMORY=2mb TTL_SECONDS=900 docker compose up -d redis cache metricas scraper
...
TTL_SECONDS=900 docker compose run --rm \
...
echo "================================="
echo "Experimento TTL 900s terminado"
echo "================================="