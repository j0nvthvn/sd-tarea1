...
echo "================================="
echo "Experimento Politica LRU"
echo "================================="


REDIS_MEMORY=2mb REDIS_POLICY=allkeys-lru docker compose up -d --force-recreate redis
...
REDIS_MEMORY=2mb REDIS_POLICY=allkeys-lru docker compose run --rm \
...
> data/resumen_politica_lru.json


docker compose exec redis redis-cli INFO stats \
| grep evicted \
> data/evicted_politica_lru.txt


docker compose exec redis redis-cli DBSIZE \
> data/dbsize_politica_lru.txt


docker compose exec redis redis-cli INFO memory \
| grep used_memory_human \
> data/memory_politica_lru.txt


echo "Experimento LRU terminado"
